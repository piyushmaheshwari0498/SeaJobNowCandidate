...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    String cand_login_flag = Constants.indosFlag;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityLoginBinding.inputIndosno.setFilters(new InputFilter[] { toUpperCaseFilter });
                ...
                switch (checkedId) {
                    case R.id.indosNoRadioBtn:
                        if (activityLoginBinding.indosNoRadioBtn.isChecked()) {
                            ...
                            cand_login_flag = Constants.indosFlag;
                        }
                        break;
                    case R.id.cdcRadioBtn:
                        if (activityLoginBinding.cdcRadioBtn.isChecked()) {
                            ...
                            cand_login_flag = Constants.cdcFlag;
                        }
                        break;
                }
            }
